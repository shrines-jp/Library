namespace ActiveDirectoryHelper
{
	...
	public class ADUserInfo
	{
			...
			string groupName )
		{
			...
			{
				var checkedGroupSamNames = new Set<string>();
		...
		/// ATTENTION! This method is slow!
		/// </summary>
		/// <value>The primary group.</value>
		public ADGroupInfo PrimaryGroup
		{
			get
			{
				if ( primaryGroupID == 0 )
				...
				else
				{
					...
					ADGroupInfo[] allGroups = owner.GetGroupInfos();
					...
					{
						foreach ( ADGroupInfo groupInfo in allGroups )
						{
							if ( groupInfo.PrimaryGroupToken == primaryGroupID )
							{
								return groupInfo;
							}
						}
		...
		/// 
		/// </summary>
		private readonly ActiveDirectory owner;
		...
		/// <returns></returns>
		private static bool DoCheckIsMemberOfGroup(
			ADGroupInfo group,
			string groupName,
